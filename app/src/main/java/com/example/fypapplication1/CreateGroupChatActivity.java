...
public class CreateGroupChatActivity extends AppCompatActivity {
            ...
            storageReference.putFile(image_uri)
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            Toast.makeText(CreateGroupChatActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
    ...
    private void pickFromCamera() {
        ...
        cv.put(MediaStore.Images.Media.TITLE, "Group title");
        cv.put(MediaStore.Images.Media.DESCRIPTION, "Group description");
