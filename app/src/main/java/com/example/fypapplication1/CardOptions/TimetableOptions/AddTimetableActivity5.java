...
public class AddTimetableActivity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_timetable5);
        ...
        reference.child(reference.push().getKey()).setValue(timetable).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful())
                    Toast.makeText(AddTimetableActivity5.this, "Slot added", Toast.LENGTH_SHORT).show();
                else
                    Toast.makeText(AddTimetableActivity5.this, "Could not add slot!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    @Override
