...
public class BoltonStreetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bolton_street);
        ...
        slideModels.add(new SlideModel(R.drawable.bolton1, ScaleTypes.FIT));
        slideModels.add(new SlideModel(R.drawable.bolton2, ScaleTypes.FIT));
        slideModels.add(new SlideModel(R.drawable.bolton3, ScaleTypes.FIT));
        ...
        btTrack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (userLocation.equals("") && userDestination.equals("")) {
                    ...
                    Toast.makeText(BoltonStreetActivity.this, "Error! Enter both locations!", Toast.LENGTH_SHORT).show();
                } else {
