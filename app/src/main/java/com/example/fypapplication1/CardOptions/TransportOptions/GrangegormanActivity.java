...
public class GrangegormanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grangegorman);
        ...
        slideModels.add(new SlideModel(R.drawable.grangegorman1, ScaleTypes.FIT));
        slideModels.add(new SlideModel(R.drawable.grangegorman2, ScaleTypes.FIT));
        slideModels.add(new SlideModel(R.drawable.grangegorman3, ScaleTypes.FIT));
        ...
        btTrack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (userLocation.equals("") && userDestination.equals("")) {
                    ...
                    Toast.makeText(GrangegormanActivity.this, "Enter both locations", Toast.LENGTH_SHORT).show();
                }else {
